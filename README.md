# Editorial Finance - Expense Management System

A fully functional Expense Management System with automated workflows, real-time analytics, and OCR receipt scanning.

## 🚀 Local Development Links

- **Frontend (Stitch UI):** [http://localhost:5500/stitch/login.html](http://localhost:5500/stitch/login.html)
...
- **Services:** Tesseract.js (OCR), JWT Authentication
...
4. **Launch Frontend:**
   Open `stitch/login.html` using a local live server (default port 5500).
